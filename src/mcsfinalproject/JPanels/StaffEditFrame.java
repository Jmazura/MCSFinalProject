...
public class StaffEditFrame extends JFrame implements ActionListener{
    
    private StaffTool adtol = new StaffTool("src/mcsfinalproject/datas/staffs.json");
    List <Staff> admins = adtol.getList();
    private int id;
    
    private JButton passEditButton, userEditButton;
    private JLabel username, password;
    private JLabel[] names, passwords;
    public StaffEditFrame(int id, JLabel[] names, JLabel[] passwords)
    {
        this.id = id;
        this.names = names;
